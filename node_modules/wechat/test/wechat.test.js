...
app.use('/myWeixinAPI', wechat('some token', function (req, res, next) {
  // 微信输入信息都在req.weixin上
  var info = req.weixin;
  // 回复屌丝(普通回复)
...
describe('myWeixinAPI.js', function () {
  ...
  describe('valid GET', function () {
    ...
    it('should 200', function (done) {
      ...
      q.echostr = 'hehe';
      request(app)
      .get('/myWeixinAPI?' + querystring.stringify(q))
      .expect(200)
      .expect('hehe', done);
    });
  ...
  describe('valid POST', function () {
    ...
    it('should 401 invalid signature', function (done) {
      ...
      q.echostr = 'hehe';
      request(app)
      .post('/myWeixinAPI?' + querystring.stringify(q))
      .expect(401)
      .expect('Invalid signature', done);
    });
  });
  ...
  describe('valid other method', function () {
    it('should 200', function (done) {
      ...
      q.echostr = 'hehe';
      request(app)
      .head('/myWeixinAPI?' + querystring.stringify(q))
      .expect(501, done);
    });
  });
