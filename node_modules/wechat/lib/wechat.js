...
var reply2CustomerService = function (fromUsername, toUsername) {
  var info = {};
  ...
  return function (req, res, next) {
    getMessage(req, function (err, result) {
      ...
      res.transfer2CustomerService = function () {
        res.writeHead(200);
        res.end(reply2CustomerService(message.ToUserName, message.FromUserName));
      };
 ...
 * ```
 * myWeixinAPI(token, function (req, res, next) {});
 *
 * myWeixinAPI(token, myWeixinAPI.text(function (message, req, res, next) {
 *   // TODO
